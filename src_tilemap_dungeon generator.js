...
class Example extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        this.map = this.make.tilemap({ tileWidth: 16, tileHeight: 16, width: this.dungeon.width, height: this.dungeon.height, orientation: Phaser.Tilemaps.Orientation.ISOMETRIC});

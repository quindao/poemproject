class Example extends Phaser.Scene
{
    ...
    preload ()
    {
        this.load.image('tiles2', './poemproject/images/tilemaps/tiles/2x/floors_exterior_street_01.png');
        this.load.image('tiles3', './poemproject/images/tilemaps/tiles/2x/walls_commercial_03.png');
        this.load.tilemapTiledJSON('map', './poemproject/images/tilemaps/isorpg.json');
        this.load.image('car', './poemproject/images/tilemaps/tiles/2x/e_exterior_snow_1.png');
    }
